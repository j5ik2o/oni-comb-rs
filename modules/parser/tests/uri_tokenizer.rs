...
fn parse_simple_uri() {
  ...
  let mut input = StrInputStream::new("http://example.com");
...
fn parse_uri_with_port() {
  let mut parser = uri_parser();
  let mut input = StrInputStream::new("https://localhost:8080");
...
fn parse_uri_with_path() {
  let mut parser = uri_parser();
  let mut input = StrInputStream::new("https://example.com/api/v1/users");
...
fn parse_uri_with_query() {
  let mut parser = uri_parser();
  let mut input = StrInputStream::new("http://example.com/search?q=rust&page=1");
...
fn parse_full_uri() {
  let mut parser = uri_parser();
  let mut input = StrInputStream::new("https://api.example.com:443/v2/data?format=json");
...
fn parse_uri_with_remaining() {
  let mut parser = uri_parser();
  let mut input = StrInputStream::new("http://example.com/path rest");
...
fn parse_ftp_scheme() {
  let mut parser = uri_parser();
  let mut input = StrInputStream::new("ftp://files.example.com/pub");
