...
#[inline]
pub(crate) fn skip_inline_ws<'a>(input: &mut StrInputStream<'a>) -> PResult<(), ParseError> {
...
#[inline]
pub(crate) fn skip_comment<'a>(input: &mut StrInputStream<'a>) -> PResult<(), ParseError> {
...
pub(crate) fn skip_ws_and_comments<'a>(input: &mut StrInputStream<'a>) -> PResult<(), ParseError> {
  loop {
...
pub(crate) fn at_document_marker<'a>(input: &StrInputStream<'a>) -> Option<&'static str> {
...
#[inline]
pub(crate) fn current_indent<'a>(input: &StrInputStream<'a>) -> usize {
  input.column() - 1
}
