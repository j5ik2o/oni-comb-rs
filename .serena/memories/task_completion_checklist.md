...
- If code is added back to the parser crate, make sure `modules/parser/Cargo.toml` bench entries and actual bench files are consistent so Cargo can parse the manifest.
