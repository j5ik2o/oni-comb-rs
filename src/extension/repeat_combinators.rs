...
pub trait RepeatCombinators: BasicCombinators {
  ...
  fn rep<'a, I, A, R>(parser: Self::P<'a, I, A>, range: R) -> Self::P<'a, I, Vec<A>>
  where
    R: RangeArgument<usize> + Debug + 'a,
    A: Debug + 'a, {
    Self::rep_sep::<'a, I, A, (), R>(parser, range, None)
  }

  fn many_0<'a, I, A>(parser: Self::P<'a, I, A>) -> Self::P<'a, I, Vec<A>>
  where
    A: Debug + 'a, {
    Self::rep_sep(parser, 0.., None as Option<Self::P<'a, I, ()>>)
  }

  fn many_1<'a, I, A>(parser: Self::P<'a, I, A>) -> Self::P<'a, I, Vec<A>>
  where
    A: Debug + 'a, {
    Self::rep_sep(parser, 1.., None as Option<Self::P<'a, I, ()>>)
  }

  fn many_n_m<'a, I, A>(parser: Self::P<'a, I, A>, n: usize, m: usize) -> Self::P<'a, I, Vec<A>>
  where
    A: Debug + 'a, {
    Self::rep_sep(parser, n..=m, None as Option<Self::P<'a, I, ()>>)
  }

  fn count<'a, I, A>(parser: Self::P<'a, I, A>, n: usize) -> Self::P<'a, I, Vec<A>>
  where
    A: Debug + 'a, {
    Self::rep_sep(parser, n, None as Option<Self::P<'a, I, ()>>)
  }
  ...
  where
    A: Debug + 'a,
    B: Debug + 'a, {
    Self::rep_sep(parser, 0.., Some(separator))
  }
  ...
  where
    A: Debug + 'a,
    B: Debug + 'a, {
    Self::rep_sep(parser, 1.., Some(separator))
  }
  ...
  where
    A: Debug + 'a,
    B: Debug + 'a, {
    Self::rep_sep(parser, n..=m, Some(separator))
  }
  ...
  where
    A: Debug + 'a,
    B: Debug + 'a, {
    Self::rep_sep(parser, n, Some(separator))
  }
}
