...
pub trait PrimitiveParsers: Parsers {
  fn begin<'a, I: Clone>() -> Self::P<'a, I, ()> {
    Self::empty()
  }

  fn end<'a, I: Clone>() -> Self::P<'a, I, ()>
  where
    I: Debug + Display + 'a;

  fn empty<'a, I: Clone>() -> Self::P<'a, I, ()>;
}
...
// 既存のParserを使用する関数
pub fn begin<'a, I: Clone>() -> Parser<'a, I, ()> {
